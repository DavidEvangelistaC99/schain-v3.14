        ...
        if dataOut.AUX==1:
            ...
            for i in range(dataOut.header[15][0]):
                for j in range(dataOut.header[17][0]):
                    ...
                    ## ACF
                    rhorp=dataOut.kabxys_integrated[8][i,j,0]+dataOut.kabxys_integrated[11][i,j,0] # cspc real + 
                    rhoip=dataOut.kabxys_integrated[10][i,j,0]-dataOut.kabxys_integrated[9][i,j,0] # cspc imag + 
