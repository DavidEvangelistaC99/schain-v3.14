...
class NormalizeDPPowerRoberto_V2(Operation):
    ...
    def normalize_Before(self,dataOut):
        ...
        ##print(dataOut.ut_Faraday)
        #'''
        if(dataOut.ut_Faraday>2.0 and dataOut.ut_Faraday<7.0):
            #print("EARLY")
            i2=(night_end-dataOut.range1[0])/dataOut.DH
            i1=(night_first-dataOut.range1[0])/dataOut.DH
            ...
            i2=(night_end-dataOut.range1[0])/dataOut.DH
            i1=(night_first1-dataOut.range1[0])/dataOut.DH
        elif (dataOut.ut_Faraday>=7.0 and dataOut.ut_Faraday<11.5):
            #print("SUNRISE")
            i2=(day_end_sunrise-dataOut.range1[0])/dataOut.DH
            i1=(day_first_sunrise-dataOut.range1[0])/dataOut.DH
        else:
    ...
    def normalize(self,dataOut):
        ...
        #if (time_text.hour == 6 and time_text.minute == 20) or (time_text.hour == 6 and time_text.minute == 30): #Year: 2024, DOY:083
            #dataOut.cf = 0.07
        #if (time_text.hour == 5 and time_text.minute == 40): #Year: 2024, DOY:083
            #dataOut.cf = 0.05
        #if (time_text.hour == 5 and time_text.minute == 10): #Year: 2024, DOY:083
            #dataOut.cf = 0.039
        #if (time_text.hour == 7 and time_text.minute == 40): #Year: 2024, DOY:083
            #dataOut.cf = 0.08
        #if (time_text.hour == 8 and time_text.minute == 10) or (time_text.hour == 8 and time_text.minute == 20) or (time_text.hour == 8 and time_text.minute == 50): #Year: 2024, DOY:083
            #dataOut.cf = 0.075
        #if (time_text.hour == 10 and time_text.minute == 50): #Year: 2024, DOY:082
            #dataOut.cf = 0.095
        #if (time_text.hour == 11 and time_text.minute == 0): #Year: 2024, DOY:081
            #dataOut.cf = 0.10
        #if (time_text.hour == 9 and time_text.minute == 10): #Year: 2024, DOY:081
            #dataOut.cf = 0.08
        #if (time_text.hour == 10 and time_text.minute == 40) or (time_text.hour == 11 and time_text.minute == 0): #Year: 2024, DOY:082
        #if (time_text.hour == 9 and time_text.minute == 0) or (time_text.hour == 9 and time_text.minute == 20) or (time_text.hour == 9 and time_text.minute == 30) or (time_text.hour == 10 and time_text.minute == 50): #Year: 2024, DOY:081
        #if (time_text.hour == 3 and time_text.minute == 10): #Year: 2024, DOY:080
            #dataOut.cf = 0.09
        #if (time_text.hour == 10 and time_text.minute == 20) or (time_text.hour == 10 and time_text.minute == 30) or (time_text.hour == 10 and time_text.minute == 40): #Year: 2024, DOY:080
            #dataOut.cf = 0.09
        #if (time_text.hour == 9 and time_text.minute == 10): #Year: 2024, DOY:080
        #if (time_text.hour == 3 and time_text.minute == 10): #Year: 2024, DOY:079
            #dataOut.cf = 0.065
        #if (time_text.hour == 3 and time_text.minute == 20): #Year: 2024, DOY:079
            #dataOut.cf = 0.05
        if (time_text.hour == 8 and time_text.minute == 40): #Year: 2024, DOY:136
            dataOut.cf = 0.006
        if (time_text.hour == 8 and time_text.minute == 45) or (time_text.hour == 8 and time_text.minute == 50): #Year: 2024, DOY:136
            dataOut.cf = 0.008
        ...
        #if (time_text.hour == 8 and time_text.minute == 20): #Year: 2024, DOY:137
            #dataOut.cf = 0.008
        #if (time_text.hour == 10 and time_text.minute == 55) or (time_text.hour == 11 and time_text.minute == 0) or (time_text.hour == 11 and time_text.minute == 5): #Year: 2024, DOY:137
            #dataOut.cf = 0.009
...
class DenCorrection_bckp_Dec_2022(NormalizeDPPowerRoberto_V2):
    ...
    def TeTiEstimation(self,dataOut):
        ...
        plt.xlim(.99,3)
        plt.grid()
        plt.savefig("/home/roberto/Pictures/Density_Comparison/V2/TeTi_from_temps/{}.png".format(dataOut.utctime))
        '''
        #dataOut.ti2 *= 5
        my_te2 = dataOut.ti2*ratio2
        #'''

        te2_aux = dataOut.te2.copy()
        te2_aux[26:] = 1000
        te2_aux[:12] = 1000
        te2_aux -= 1000
        def func(params):
            #return (dataOut.te2-self.gaussian(dataOut.heightList[:dataOut.NSHTS],params[0],params[1],params[2]))
            return (te2_aux-self.gaussian(dataOut.heightList[:dataOut.NSHTS],params[0],params[1],params[2]))
        x0_value = numpy.array([1000,250,20])
        popt = least_squares(func,x0=x0_value,verbose=0)
        A = popt.x[0]; B = popt.x[1]; C = popt.x[2]
        te2_smooth = self.gaussian(dataOut.heightList[:dataOut.NSHTS], A, B, C)+1000
        te2_aux += 1000
        #'''
        ti2_smooth = te2_smooth/ratio2
        '''
        import matplotlib.pyplot as plt
        plt.clf()
        plt.plot(te2_smooth,dataOut.heightList[:dataOut.NSHTS],'*-',label = 'My Te')
        plt.plot(ti2_smooth,dataOut.heightList[:dataOut.NSHTS],'*-',label = 'My Ti')
        plt.plot(dataOut.te2,dataOut.heightList[:dataOut.NSHTS],'*-',label = 'Te')
        plt.plot(te2_aux,dataOut.heightList[:dataOut.NSHTS],'*-',label = 'Te_aux')
        plt.plot(ratio2*1000,dataOut.heightList[:dataOut.NSHTS],'*-',label = 'ratio*1000')
        #plt.plot(signal.medfilt(dataOut.te2),dataOut.heightList[:dataOut.NSHTS],'*-',label = 'Te')
        plt.title("{}".format(datetime.datetime.fromtimestamp(dataOut.utctime)))
        plt.xlim(-50,3000)
        plt.grid()
        plt.legend()
        plt.savefig("/home/roberto/Pictures/Density_Comparison/V3/Temps+{}.png".format(dataOut.utctime))
        #plt.show()
        '''
        ...
        #plt.savefig("/home/roberto/Pictures/Density_Comparison/V2/TeTi_cte/Te2/{}.png".format(dataOut.utctime))
        #plt.savefig("/home/roberto/Pictures/Density_Comparison/V2/bline/Te2/{}.png".format(dataOut.utctime))
        plt.savefig("/home/roberto/Pictures/Density_Comparison/V3/{}.png".format(dataOut.utctime))
...
class DataSaveCleaner(Operation):
    ...
    def run(self,dataOut,savecfclean=0):
        ...
        #if (time_text.hour == 3 and time_text.minute == 56) or (time_text.hour == 2 and time_text.minute == 30) or (time_text.hour == 2 and time_text.minute == 20) or (time_text.hour == 2 and time_text.minute == 9) or (time_text.hour == 8 and time_text.minute >= 22) or (time_text.hour >= 9 and time_text.hour < 11): #Year: 2022, DOY:103
        #if (time_text.hour >= 8 and time_text.hour < 11) or (time_text.hour == 11 and time_text.minute == 2) or (time_text.hour == 11 and time_text.minute == 13): #Year: 2022, DOY:104
        #if (time_text.hour == 17 and time_text.minute == 34): #Year: 2022, DOY:89
        #if (time_text.hour == 7 and time_text.minute>=40) or (time_text.hour >= 8 and time_text.hour<11) or (time_text.hour == 11 and time_text.minute<=25): #Year: 2022, DOY:90
        ...
        #if (time_text.hour >= 5 and time_text.hour < 11) or (time_text.hour == 11  and time_text.minute<30): #Year: 2023, DOY:171
        #if (time_text.hour == 19 and time_text.minute > 40) or (time_text.hour == 20 and time_text.minute<20) or (time_text.hour == 6 and time_text.minute==57) or (time_text.hour > 6 and time_text.hour < 11) or (time_text.hour == 11 and time_text.minute<40): #Year: 2023, DOY:172
        #if (time_text.hour >= 5 and time_text.hour < 11) or (time_text.hour == 11 and time_text.minute < 40) or (time_text.hour == 16 and time_text.minute == 12): #Year: 2023, DOY:173
        #if (time_text.hour >= 5 and time_text.hour < 11) or (time_text.hour == 11 and time_text.minute == 2) or (time_text.hour == 20 and time_text.minute > 30)  or (time_text.hour == 21) or (time_text.hour == 22 and time_text.minute < 40): #Year: 2023, DOY:174
        #if (time_text.hour == 19 and time_text.minute == 41): #Year: 2023, DOY:195
        #if (time_text.hour == 22 and time_text.minute == 0) or (time_text.hour == 10) or (time_text.hour == 11 and time_text.minute == 0): #Year: 2023, DOY:248
        #if (time_text.hour >= 8 and time_text.hour <= 10) or (time_text.hour == 3 and time_text.minute == 50) or (time_text.hour == 4 and time_text.minute == 0): #Year: 2023, DOY:249
        #if (time_text.hour == 8 and time_text.minute >= 40) or (time_text.hour == 9 or time_text.hour == 10) or (time_text.hour == 11 and time_text.minute <= 20): #Year: 2023, DOY:250
        #if (time_text.hour == 23 and time_text.minute >= 20) or (time_text.hour >= 0 and time_text.hour <= 2) or (time_text.hour == 4 and time_text.minute >= 20): #Year: 2023, DOY:264
        ...
        #if (time_text.hour == 1 and time_text.minute == 50): #Year: 2024, DOY:082
        #if (time_text.hour == 9 and time_text.minute >= 40) or (time_text.hour == 10 and time_text.minute <= 30): #Year: 2024, DOY:081
        #if (time_text.hour == 1 and time_text.minute <= 20): #Year: 2024, DOY:080
        #if (time_text.hour == 3 and time_text.minute <= 40): #Year: 2024, DOY:079
        #if (time_text.hour == 3 and time_text.minute == 55): #Year: 2024, DOY:135
        if (time_text.hour == 7 and time_text.minute >= 45) or (time_text.hour == 8 and time_text.minute <= 15): #Year: 2024, DOY:137
            ...
            '''
        '''
        if (time_text.hour == 5) or (time_text.hour == 6) or (time_text.hour == 7) or (time_text.hour == 8) or (time_text.hour == 9) or (time_text.hour == 10) or (time_text.hour == 11 and time_text.minute <= 15): #Year: 2024, DOY:138
            id_aux = 13
        ...
        if (time_text.hour == 11 and time_text.minute >= 20) or (time_text.hour == 12): #Year: 2024, DOY:138
            id_aux = 9
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 6 and time_text.minute == 0): #Year: 2024, DOY:138
            id_aux = 38
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute == 10): #Year: 2024, DOY:138
            id_aux = 40
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute == 20) or (time_text.hour == 6 and time_text.minute == 25) or (time_text.hour == 10 and time_text.minute == 25) or (time_text.hour == 11 and time_text.minute == 35) or (time_text.hour == 12 and time_text.minute == 15): #Year: 2024, DOY:138
            id_aux = 37
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute == 50) or (time_text.hour == 6 and time_text.minute == 55) or (time_text.hour == 9 and time_text.minute >= 45) or (time_text.hour == 10 and time_text.minute == 0) or (time_text.hour == 10 and time_text.minute == 15): #Year: 2024, DOY:138
            id_aux = 33
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 7 and time_text.minute == 15) or (time_text.hour == 7 and time_text.minute == 20) or (time_text.hour == 9 and time_text.minute == 40) or (time_text.hour == 9 and time_text.minute == 55) or (time_text.hour == 10 and time_text.minute == 10): #Year: 2024, DOY:138
            id_aux = 31
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 7 and time_text.minute == 35) or (time_text.hour == 7 and time_text.minute == 50) or (time_text.hour == 8 and time_text.minute == 10): #Year: 2024, DOY:138
            id_aux = 28
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 8 and time_text.minute == 20): #Year: 2024, DOY:138
            id_aux = 29
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 8 and time_text.minute == 45) or (time_text.hour == 8 and time_text.minute == 50) or (time_text.hour == 10 and time_text.minute == 45) or (time_text.hour == 11 and time_text.minute == 0) or (time_text.hour == 11 and time_text.minute == 20): #Year: 2024, DOY:138
            id_aux = 32
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 10 and time_text.minute == 40) or (time_text.hour == 11 and time_text.minute == 25): #Year: 2024, DOY:138
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 12 and time_text.minute == 30): #Year: 2024, DOY:138
            id_aux = 38
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            '''
        '''
        if (time_text.hour == 5 and time_text.minute <= 10): #Year: 2024, DOY:137
            id_aux = 14
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
        ...
        if (time_text.hour == 5 and time_text.minute <= 40) or (time_text.hour == 6 and time_text.minute == 45) or (time_text.hour == 8) or (time_text.hour == 21 and time_text.minute <= 20) or (time_text.hour == 22 and time_text.minute >= 50) or (time_text.hour == 23) or (time_text.hour == 0) or (time_text.hour == 1) or (time_text.hour == 2) or (time_text.hour == 3) or (time_text.hour == 4): #Year: 2024, DOY:137
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 5) or (time_text.hour == 6) or (time_text.hour == 9) or (time_text.hour == 10): #Year: 2024, DOY:137
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 7) or (time_text.hour == 23 and time_text.minute == 0): #Year: 2024, DOY:137
            id_aux = 15
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 11 and time_text.minute <= 10): #Year: 2024, DOY:137
            id_aux = 16
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 12 and time_text.minute > 15) or (time_text.hour == 11) or (time_text.hour == 12): #Year: 2024, DOY:137
            id_aux = 9
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 22): #Year: 2024, DOY:137
            id_aux = 10
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 22 and time_text.minute == 45): #Year: 2024, DOY:137
            id_aux = 11
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 5) or (time_text.hour == 23 and time_text.minute == 10): #Year: 2024, DOY:137
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 0 and time_text.minute == 5) or (time_text.hour == 0 and time_text.minute == 10) or (time_text.hour == 0 and time_text.minute == 15): #Year: 2024, DOY:137
            id_aux = 25
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 10) or (time_text.hour == 2 and time_text.minute == 15): #Year: 2024, DOY:137
            id_aux = 24
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 5 and time_text.minute == 10) or (time_text.hour == 11 and time_text.minute == 15): #Year: 2024, DOY:137
            id_aux = 40
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 8 and time_text.minute == 30) or (time_text.hour == 8 and time_text.minute == 45) or (time_text.hour == 8 and time_text.minute == 50): #Year: 2024, DOY:137
            id_aux = 33
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute == 0) or (time_text.hour == 11 and time_text.minute == 5) or (time_text.hour == 11 and time_text.minute == 20): #Year: 2024, DOY:137
            id_aux = 34
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute == 5) or (time_text.hour == 6 and time_text.minute == 20) or (time_text.hour == 9 and time_text.minute >= 10) or (time_text.hour == 10 and time_text.minute == 15) or (time_text.hour == 5 and time_text.minute == 45): #Year: 2024, DOY:137
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute == 35) or (time_text.hour == 7 and time_text.minute == 55) or (time_text.hour == 10 and time_text.minute == 20): #Year: 2024, DOY:137
            id_aux = 29
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute >= 45) or (time_text.hour == 7 and time_text.minute == 40) or (time_text.hour == 8 and time_text.minute == 20) or (time_text.hour == 9 and time_text.minute == 10) or (time_text.hour == 9 and time_text.minute == 40) or (time_text.hour == 10 and time_text.minute == 30): #Year: 2024, DOY:137
            id_aux = 30
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 9 and time_text.minute == 50): #Year: 2024, DOY:137
            id_aux = 31
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 7 and time_text.minute == 20) or (time_text.hour == 7 and time_text.minute == 25): #Year: 2024, DOY:137
            id_aux = 27
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 17 and time_text.minute == 45) or (time_text.hour == 11 and time_text.minute == 45): #Year: 2024, DOY:137
            id_aux = 39
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 17 and time_text.minute == 50) or (time_text.hour == 18 and time_text.minute == 35) or (time_text.hour == 21 and time_text.minute == 10): #Year: 2024, DOY:137
            id_aux = (38,39)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 20 and time_text.minute == 55): #Year: 2024, DOY:137
            id_aux = 38
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 5): #Year: 2024, DOY:137
            id_aux = (37,38,39)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 18 and time_text.minute == 0): #Year: 2024, DOY:137
            id_aux = (24,25)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 5) or (time_text.hour == 6) or (time_text.hour == 7) or (time_text.hour == 8) or (time_text.hour == 9) or (time_text.hour == 10) or (time_text.hour == 11 and time_text.minute <= 30) or (time_text.hour == 1 and time_text.minute >= 35) or (time_text.hour == 2): #Year: 2024, DOY:136
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 11 and time_text.minute == 35) or (time_text.hour == 11 and time_text.minute == 40): #Year: 2024, DOY:136
            id_aux = 11
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 11 and time_text.minute >= 45) or (time_text.hour == 12 and time_text.minute <= 40) or (time_text.hour == 21 and time_text.minute >= 20) or (time_text.hour == 22 and time_text.minute <= 15): #Year: 2024, DOY:136
            id_aux = 9
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 12 and time_text.minute > 40) or (time_text.hour == 21 and time_text.minute <= 15) or (time_text.hour == 22 and time_text.minute == 55) or (time_text.hour == 3) or (time_text.hour == 4): #Year: 2024, DOY:136
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 22 and time_text.minute >= 20): #Year: 2024, DOY:136
            id_aux = 10
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute <= 10): #Year: 2024, DOY:136
            id_aux = 16
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute >= 15): #Year: 2024, DOY:136
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 40): #Year: 2024, DOY:136
            id_aux = 15
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 1 and time_text.minute == 30): #Year: 2024, DOY:136
            id_aux = 19
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 0 and time_text.minute == 40): #Year: 2024, DOY:136
            id_aux = 20
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 4 and time_text.minute >= 25): #Year: 2024, DOY:136
            id_aux = 14
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 6 and time_text.minute <= 10) or (time_text.hour == 9 and time_text.minute == 45) or (time_text.hour == 12 and time_text.minute == 25): #Year: 2024, DOY:136
            id_aux = 37
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        if (time_text.hour == 6 and time_text.minute == 40) or (time_text.hour == 6 and time_text.minute == 45) or (time_text.hour == 9 and time_text.minute == 35) or (time_text.hour == 11 and time_text.minute == 15) or (time_text.hour == 11 and time_text.minute == 25) or (time_text.hour == 11 and time_text.minute == 35) or (time_text.hour == 8 and time_text.minute == 25): #Year: 2024, DOY:136
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute == 50) or (time_text.hour == 7 and time_text.minute == 5) or (time_text.hour == 10 and time_text.minute == 15) or (time_text.hour == 11 and time_text.minute == 50) or (time_text.hour == 12 and time_text.minute == 15) or (time_text.hour == 10 and time_text.minute == 50): #Year: 2024, DOY:136
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        if (time_text.hour == 7 and time_text.minute == 10) or (time_text.hour == 7 and time_text.minute == 15) or (time_text.hour == 7 and time_text.minute == 20) or (time_text.hour == 7 and time_text.minute == 30) or (time_text.hour == 8 and time_text.minute == 30) or (time_text.hour == 8 and time_text.minute == 55) or (time_text.hour == 9 and time_text.minute == 0) or (time_text.hour == 10 and time_text.minute == 30) or (time_text.hour == 7 and time_text.minute == 30) or (time_text.hour == 8 and time_text.minute == 30) or (time_text.hour == 8 and time_text.minute == 55) or (time_text.hour == 9 and time_text.minute == 0) or (time_text.hour == 10 and time_text.minute == 40): #Year: 2024, DOY:136
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 8 and time_text.minute == 5): #Year: 2024, DOY:136
            id_aux = 26
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 8 and time_text.minute == 15): #Year: 2024, DOY:136
            id_aux = 27
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 10 and time_text.minute == 20) or (time_text.hour == 12 and time_text.minute == 35): #Year: 2024, DOY:136
            id_aux = 39
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 10 and time_text.minute == 45): #Year: 2024, DOY:136
            id_aux = 29
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 21 and time_text.minute == 55): #Year: 2024, DOY:136
            id_aux = 51
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            '''
        '''
        if (time_text.hour == 14 and time_text.minute == 0): #Year: 2024, DOY:135
            id_aux = 40
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 14 and time_text.minute == 10): #Year: 2024, DOY:135
            id_aux = 38
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 21 and time_text.minute >= 40) or (time_text.hour == 22 and time_text.minute <= 30): #Year: 2024, DOY:135
            id_aux = 10
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 22 and time_text.minute == 35): #Year: 2024, DOY:135
            id_aux = 11
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 22 and time_text.minute == 40) or (time_text.hour == 22 and time_text.minute == 45): #Year: 2024, DOY:135
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 22 and time_text.minute == 50) or (time_text.hour == 4 and time_text.minute == 25) or (time_text.hour == 23) or (time_text.hour <= 4): #Year: 2024, DOY:135
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 22 and time_text.minute == 55) or (time_text.hour == 23 and time_text.minute == 5) or (time_text.hour == 3 and time_text.minute == 30) or (time_text.hour == 3 and time_text.minute == 35): #Year: 2024, DOY:135
            id_aux = 15
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 0) or (time_text.hour == 3 and time_text.minute == 25): #Year: 2024, DOY:135
            id_aux = 16
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 20): #Year: 2024, DOY:135
            id_aux = 19
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 50): #Year: 2024, DOY:135
            id_aux = 21
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 0 and time_text.minute == 30): #Year: 2024, DOY:135
            id_aux = 24
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 0) or (time_text.hour == 2 and time_text.minute == 15) or (time_text.hour == 0 and time_text.minute == 50) or (time_text.hour == 0 and time_text.minute == 55) or (time_text.hour == 1 and time_text.minute == 0) or (time_text.hour == 1 and time_text.minute == 5): #Year: 2024, DOY:135
            id_aux = 23
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 15): #Year: 2024, DOY:135
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 21 and time_text.minute <= 30): #Year: 2024, DOY:079
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 21 and time_text.minute == 40) or (time_text.hour == 23 and time_text.minute == 10) or (time_text.hour == 23 and time_text.minute == 20) or (time_text.hour == 3 and time_text.minute == 50): #Year: 2024, DOY:079
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 22 and time_text.minute >= 20) or (time_text.hour == 4): #Year: 2024, DOY:079
            id_aux = 10
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 0): #Year: 2024, DOY:079
            id_aux = 11
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute >= 30) or (time_text.hour == 0) or (time_text.hour == 1) or (time_text.hour == 2 and time_text.minute == 0): #Year: 2024, DOY:079
            id_aux = 15
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 10): #Year: 2024, DOY:079
            id_aux = 18
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 20): #Year: 2024, DOY:079
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 11) or (time_text.hour == 12): #Year: 2024, DOY:080
            id_aux = 9
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 5) or (time_text.hour == 6) or (time_text.hour == 7) or (time_text.hour == 8) or (time_text.hour == 9) or (time_text.hour == 10 and time_text.minute <= 10) or (time_text.hour == 10 and time_text.minute == 30) or (time_text.hour == 10 and time_text.minute == 40) or (time_text.hour == 22 and time_text.minute >= 30) or (time_text.hour == 4 and time_text.minute == 40): #Year: 2024, DOY:080
            id_aux = 10
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
        ...
        if (time_text.hour == 7 and time_text.minute == 20) or (time_text.hour == 9 and time_text.minute == 20) or (time_text.hour == 9 and time_text.minute == 30) or (time_text.hour == 10 and time_text.minute == 20) or (time_text.hour == 23 and time_text.minute <= 10) or (time_text.hour == 2) or (time_text.hour == 3) or (time_text.hour == 4 and time_text.minute <= 30): #Year: 2024, DOY:080
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 7 and time_text.minute == 40) or (time_text.hour == 8 and time_text.minute == 20) or (time_text.hour == 8 and time_text.minute == 40) or (time_text.hour == 9 and time_text.minute == 50) or (time_text.hour == 21 and time_text.minute <= 10): #Year: 2024, DOY:080
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 20) or (time_text.hour == 23 and time_text.minute == 30): #Year: 2024, DOY:080
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute >= 40): #Year: 2024, DOY:080
            id_aux = 21
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 1 and time_text.minute == 30): #Year: 2024, DOY:080
            id_aux = 29
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 1 and time_text.minute == 40): #Year: 2024, DOY:080
            id_aux = 26
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 50): #Year: 2024, DOY:080
            id_aux = 21
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 10) or (time_text.hour == 3 and time_text.minute == 20): #Year: 2024, DOY:080
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 7 and time_text.minute == 30) or (time_text.hour == 9 and time_text.minute == 50): #Year: 2024, DOY:080
            id_aux = 38
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 8 and time_text.minute == 40) or (time_text.hour == 10 and time_text.minute == 30) or (time_text.hour == 10 and time_text.minute == 40) or (time_text.hour == 12 and time_text.minute == 20): #Year: 2024, DOY:080
            id_aux = 35
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 11 and time_text.minute == 50): #Year: 2024, DOY:080
            id_aux = 32
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            '''
        '''
        if (time_text.hour == 5) or (time_text.hour == 6) or (time_text.hour == 7) or (time_text.hour == 8) or (time_text.hour == 9 and time_text.minute == 0) or (time_text.hour == 22): #Year: 2024, DOY:081
            id_aux = 10
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 9 and time_text.minute >= 10) or (time_text.hour == 10 and time_text.minute == 0) or (time_text.hour == 11 and time_text.minute == 0): #Year: 2024, DOY:081
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 10 and time_text.minute == 10): #Year: 2024, DOY:081
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 10 and time_text.minute >= 40) or (time_text.hour == 11 and time_text.minute == 10) or (time_text.hour == 11 and time_text.minute == 20) or (time_text.hour == 3) or (time_text.hour == 4): #Year: 2024, DOY:081
            id_aux = 11
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 11 and time_text.minute >= 30) or (time_text.hour == 12 and time_text.minute <= 10): #Year: 2024, DOY:081
            id_aux = 9
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 21 and time_text.minute == 0) or (time_text.hour == 23) or (time_text.hour == 0) or (time_text.hour == 1) or (time_text.hour == 2): #Year: 2024, DOY:081
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 8 and time_text.minute == 10) or (time_text.hour == 9 and time_text.minute == 10) or (time_text.hour == 9 and time_text.minute == 20) or (time_text.hour == 9 and time_text.minute == 40) or (time_text.hour == 10 and time_text.minute == 10) or (time_text.hour == 11 and time_text.minute == 50): #Year: 2024, DOY:081
            id_aux = 33
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 10 and time_text.minute == 30): #Year: 2024, DOY:081
            id_aux = 29
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 12 and time_text.minute == 20): #Year: 2024, DOY:081
            id_aux = 38
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            '''
        '''
        if (time_text.hour == 5) or (time_text.hour == 6 and time_text.minute == 0) or (time_text.hour == 6 and time_text.minute >= 20) or (time_text.hour == 7) or (time_text.hour == 8 and time_text.minute == 0) or (time_text.hour == 3 and time_text.minute >= 40) or (time_text.hour == 4 and time_text.minute >= 30): #Year: 2024, DOY:082
            id_aux = 11
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 6 and time_text.minute == 10) or (time_text.hour == 8 and time_text.minute >= 10) or (time_text.hour == 9) or (time_text.hour == 10) or (time_text.hour == 23 and time_text.minute <= 10): #Year: 2024, DOY:082
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 11) or (time_text.hour == 12): #Year: 2024, DOY:082
            id_aux = 9
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 22 and time_text.minute >= 20) or (time_text.hour == 4 and time_text.minute <= 20): #Year: 2024, DOY:082
            id_aux = 10
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute >= 20) or (time_text.hour == 1) or (time_text.hour == 2) or (time_text.hour == 3 and time_text.minute <= 30): #Year: 2024, DOY:082
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 50): #Year: 2024, DOY:082
            id_aux = 19
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 10): #Year: 2024, DOY:082
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 9 and time_text.minute == 30) or (time_text.hour == 11 and time_text.minute == 20): #Year: 2024, DOY:082
            id_aux = 37
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 18 and time_text.minute == 50) or (time_text.hour == 19 and time_text.minute == 0): #Year: 2024, DOY:082
            id_aux = 57
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            '''
        '''
        if (time_text.hour == 5) or (time_text.hour == 6 and time_text.minute == 0) or (time_text.hour == 10 and time_text.minute == 20) or (time_text.hour == 10 and time_text.minute == 30): #Year: 2024, DOY:083
            id_aux = 10
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 6 and time_text.minute == 10) or (time_text.hour == 6 and time_text.minute == 20) or (time_text.hour == 9 and time_text.minute >= 30) or (time_text.hour == 10 and time_text.minute <= 10) or (time_text.hour == 10 and time_text.minute == 50): #Year: 2024, DOY:083
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 6 and time_text.minute >= 30) or (time_text.hour == 7) or (time_text.hour == 8) or (time_text.hour == 9 and time_text.minute <= 20): #Year: 2024, DOY:083
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 11) or (time_text.hour == 12): #Year: 2024, DOY:083
            id_aux = 9
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 11 and time_text.minute == 40): #Year: 2024, DOY:083
            id_aux = 39
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        if (time_text.hour == 11 and time_text.minute == 40): #Year: 2023, DOY:268
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 12 and time_text.minute == 50) or (time_text.hour == 13 and time_text.minute == 40): #Year: 2023, DOY:268
            id_aux = 39
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        if (time_text.hour == 5) or (time_text.hour == 10 and time_text.minute == 40) or (time_text.hour == 22 and time_text.minute >= 40) or (time_text.hour == 23 and time_text.minute == 0) or (time_text.hour == 3 and time_text.minute == 20) or (time_text.hour == 4 and time_text.minute == 40) or (time_text.hour == 6 and time_text.minute == 50): #Year: 2023, DOY:268
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2): #Year: 2023, DOY:268
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 8 and time_text.minute == 10) or (time_text.hour == 6 and time_text.minute <= 40) or (time_text.hour == 7 and time_text.minute >= 10): #Year: 2023, DOY:268
            id_aux = 16
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 7 and time_text.minute == 0) or (time_text.hour == 9 and time_text.minute == 20) or (time_text.hour == 23 and time_text.minute >= 10): #Year: 2023, DOY:268
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 20) or (time_text.hour == 23 and time_text.minute == 30): #Year: 2023, DOY:268
            id_aux = 18
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 8 and time_text.minute == 0) or (time_text.hour == 9 and time_text.minute == 50) or (time_text.hour == 10 and time_text.minute <= 10): #Year: 2023, DOY:268
            id_aux = 19
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 8 and time_text.minute == 50): #Year: 2023, DOY:268
            id_aux = 20
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 0) or (time_text.hour == 1) or (time_text.hour == 2 and time_text.minute == 0): #Year: 2023, DOY:268
            id_aux = 21
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
        ...
        if (time_text.hour == 8 and time_text.minute == 20) or (time_text.hour == 8 and time_text.minute == 30) or (time_text.hour == 8 and time_text.minute == 40) or (time_text.hour == 9 and time_text.minute <= 10) or (time_text.hour == 9 and time_text.minute == 30) or (time_text.hour == 9 and time_text.minute == 40) or (time_text.hour == 23 and time_text.minute == 40): #Year: 2023, DOY:268
            ...
            '''
        '''
        if (time_text.hour == 11 and time_text.minute == 20): #Year: 2023, DOY:267
            id_aux = 25
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 11 and time_text.minute == 10): #Year: 2023, DOY:267
            id_aux = 26
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 10 and time_text.minute == 50) or (time_text.hour == 11 and time_text.minute == 0): #Year: 2023, DOY:267
            id_aux = 27
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 10 and time_text.minute == 30) or (time_text.hour == 10 and time_text.minute == 40): #Year: 2023, DOY:267
            id_aux = 31
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 5 and time_text.minute == 0) or (time_text.hour == 11 and time_text.minute == 40) or (time_text.hour == 13 and time_text.minute == 50): #Year: 2023, DOY:267
            id_aux = 39
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute == 10) or (time_text.hour == 6 and time_text.minute == 20) or (time_text.hour == 7 and time_text.minute >= 40) or (time_text.hour == 8 and time_text.minute == 0) or (time_text.hour == 8 and time_text.minute >= 30) or (time_text.hour == 9 and time_text.minute >= 30): #Year: 2023, DOY:267
            id_aux = 34
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 23 and time_text.minute == 0) or (time_text.hour == 23 and time_text.minute == 20): #Year: 2023, DOY:267
            id_aux = 35
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        if (time_text.hour == 10 and time_text.minute == 30) or (time_text.hour == 10 and time_text.minute == 50) or (time_text.hour == 11 and time_text.minute == 10) or (time_text.hour == 11 and time_text.minute == 20) or (time_text.hour == 11 and time_text.minute == 50) or (time_text.hour == 12 and time_text.minute == 30) or (time_text.hour == 12 and time_text.minute == 50): #Year: 2023, DOY:267
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 2 and time_text.minute == 50): #Year: 2023, DOY:267
            id_aux = 40
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        if (time_text.hour == 4) or (time_text.hour == 3) or (time_text.hour == 2) or (time_text.hour == 1) or (time_text.hour == 0 and time_text.minute == 50) or (time_text.hour == 22 and time_text.minute == 40) or (time_text.hour == 5 and time_text.minute == 0) or (time_text.hour == 5 and time_text.minute == 40) or (time_text.hour == 6 and time_text.minute == 0) or (time_text.hour == 6 and time_text.minute >= 20) or (time_text.hour == 7) or (time_text.hour == 8) or (time_text.hour == 9) or (time_text.hour == 10 and time_text.minute <= 30): #Year: 2023, DOY:267
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 7 and time_text.minute == 50): #Year: 2023, DOY:267
            id_aux = 14
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 22 and time_text.minute == 50) or (time_text.hour == 10 and time_text.minute == 0): #Year: 2023, DOY:267
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute >= 10) or (time_text.hour == 0 and time_text.minute <= 20): #Year: 2023, DOY:267
            id_aux = 22
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 40): #Year: 2023, DOY:267
            id_aux = 24
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 11 and time_text.minute == 0): #Year: 2023, DOY:266
            id_aux = 28
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 9 and time_text.minute == 40) or (time_text.hour == 10 and time_text.minute <= 10): #Year: 2023, DOY:266
            id_aux = 33
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 12 and time_text.minute == 0) or (time_text.hour == 9 and time_text.minute <= 10) or (time_text.hour == 9 and time_text.minute == 30): #Year: 2023, DOY:266
            id_aux = 34
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 12 and time_text.minute == 10) or (time_text.hour == 12 and time_text.minute == 20) or (time_text.hour == 5 and time_text.minute == 50) or (time_text.hour == 8 and time_text.minute >= 30): #Year: 2023, DOY:266
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 8 and time_text.minute == 10): #Year: 2023, DOY:266
            id_aux = 38
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute == 0): #Year: 2023, DOY:266
            id_aux = 39
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 23 and time_text.minute == 20): #Year: 2023, DOY:266
            id_aux = 40
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 22 and time_text.minute == 10): #Year: 2023, DOY:266
            id_aux = 9
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 4) or (time_text.hour == 3 and time_text.minute >= 10) or (time_text.hour == 5 and time_text.minute == 10) or (time_text.hour == 5 and time_text.minute == 20) or (time_text.hour == 5 and time_text.minute == 30) or (time_text.hour == 6 and time_text.minute == 30) or (time_text.hour == 7): #Year: 2023, DOY:266
            id_aux = 11
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 0) or (time_text.hour == 2 and time_text.minute >= 20) or (time_text.hour == 23 and time_text.minute == 10) or (time_text.hour == 22 and time_text.minute == 50) or (time_text.hour == 6 and time_text.minute == 40) or (time_text.hour == 10): #Year: 2023, DOY:266
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 8) or (time_text.hour == 9): #Year: 2023, DOY:266
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute >= 20) or (time_text.hour == 0) or (time_text.hour == 1) or (time_text.hour == 2 and time_text.minute == 0): #Year: 2023, DOY:266
            id_aux = 21
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 5 and time_text.minute <= 10): #Year: 2023, DOY:265
            id_aux = 24
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 2 and time_text.minute == 40): #Year: 2023, DOY:265
            id_aux = 28
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 10 and time_text.minute == 30) or (time_text.hour == 6 and time_text.minute == 0) or (time_text.hour == 6 and time_text.minute == 20) or (time_text.hour == 3 and time_text.minute == 0): #Year: 2023, DOY:265
            id_aux = 30
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 11) or (time_text.hour == 12 and time_text.minute <= 10): #Year: 2023, DOY:265
            id_aux = 31
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 2 and time_text.minute == 50) or (time_text.hour == 3 and time_text.minute == 20) or (time_text.hour == 3 and time_text.minute == 30) or (time_text.hour == 3 and time_text.minute == 50): #Year: 2023, DOY:265
            id_aux = 32
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 8 and time_text.minute == 0) or (time_text.hour == 12 and time_text.minute == 50) or (time_text.hour == 13 and time_text.minute == 0) or (time_text.hour == 13 and time_text.minute == 50) or (time_text.hour == 4 and time_text.minute <= 10): #Year: 2023, DOY:265
            id_aux = 33
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 3 and time_text.minute == 10) or (time_text.hour == 14 and time_text.minute == 0): #Year: 2023, DOY:265
            id_aux = 34
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute >= 30) or (time_text.hour == 7 and time_text.minute == 10): #Year: 2023, DOY:265
            id_aux = 35
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 15 and time_text.minute == 0): #Year: 2023, DOY:265
            id_aux = 38
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 23) or (time_text.hour == 4 and time_text.minute == 30): #Year: 2023, DOY:265
            id_aux = 15
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
        ...
        if (time_text.hour == 2 and time_text.minute == 40): #Year: 2023, DOY:265
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 5) or (time_text.hour == 10 and time_text.minute == 40) or (time_text.hour == 8 and time_text.minute == 0): #Year: 2023, DOY:265
            id_aux = 10
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
        ...
        if (time_text.hour == 2 and time_text.minute == 50) or (time_text.hour == 3 and time_text.minute <= 30) or (time_text.hour == 3 and time_text.minute == 50) or (time_text.hour == 4 and time_text.minute == 0) or (time_text.hour == 22 and time_text.minute >= 40) or (time_text.hour == 10 and time_text.minute == 50) or (time_text.hour == 7 and time_text.minute >= 30) or (time_text.hour == 9) or (time_text.hour == 10 and time_text.minute <= 30): #Year: 2023, DOY:265
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 4 and time_text.minute == 20): #Year: 2023, DOY:265
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 40): #Year: 2023, DOY:265
            id_aux = 14
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute >= 30) or (time_text.hour == 0 or time_text.hour == 1): #Year: 2023, DOY:265
            id_aux = 22
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 50): #Year: 2023, DOY:265
            id_aux = 25
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 14 and time_text.minute == 10): #Year: 2023, DOY:264
            id_aux = 39
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 22): #Year: 2023, DOY:264
            id_aux = 9
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 22 and time_text.minute == 40) or(time_text.hour == 3 or time_text.hour == 4) : #Year: 2023, DOY:264
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 5 and time_text.minute == 40) or (time_text.hour == 6 and time_text.minute >= 10) or (time_text.hour == 8 and time_text.minute == 30) or (time_text.hour == 8 and time_text.minute == 40) or (time_text.hour == 9 and time_text.minute == 10) or (time_text.hour == 9 and time_text.minute == 50): #Year: 2023, DOY:269
            id_aux = 35
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute == 50) or (time_text.hour == 7 and time_text.minute == 50) or (time_text.hour == 8 and time_text.minute == 10) or (time_text.hour == 8 and time_text.minute == 20) or (time_text.hour == 10 and time_text.minute == 30) or (time_text.hour == 11 and time_text.minute == 10): #Year: 2023, DOY:269
            id_aux = 34
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 8 and time_text.minute == 50): #Year: 2023, DOY:269
            id_aux = 38
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 10 and time_text.minute == 50) or (time_text.hour == 11 and time_text.minute == 0): #Year: 2023, DOY:269
            id_aux = 32
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 11 and time_text.minute == 20): #Year: 2023, DOY:269
            id_aux = 30
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 11 and time_text.minute == 50) or (time_text.hour == 12 and time_text.minute == 10): #Year: 2023, DOY:269
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour >= 5 or time_text.hour <= 9): #Year: 2023, DOY:269
            id_aux = 11
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 7) or (time_text.hour == 8 or time_text.minute == 20): #Year: 2023, DOY:269
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 6 and time_text.minute == 50) or (time_text.hour == 7 and time_text.minute < 30): #Year: 2023, DOY:250
            id_aux = 37
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 7 and time_text.minute >= 30) or (time_text.hour == 8 and time_text.minute == 0) or (time_text.hour == 9 and time_text.minute == 10) or (time_text.hour == 11 and time_text.minute == 40) or (time_text.hour == 12 and time_text.minute == 50): #Year: 2023, DOY:250
            id_aux = 34
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour >= 5 and time_text.hour <= 9) or (time_text.hour == 10 and time_text.minute <= 40): #Year: 2023, DOY:250
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 10 or time_text.hour == 11): #Year: 2023, DOY:250
            id_aux = 10
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 5 and time_text.minute == 30) or (time_text.hour == 6 and time_text.minute == 0): #Year: 2023, DOY:249
            id_aux = 38
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour >= 8 and time_text.hour <= 11) or (time_text.hour == 12 and time_text.minute <= 20): #Year: 2023, DOY:249
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 13 and time_text.minute == 0): #Year: 2023, DOY:249
            id_aux = 40
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        if (time_text.hour == 4 and time_text.minute == 10): #Year: 2023, DOY:249
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 4 and time_text.minute == 20): #Year: 2023, DOY:249
            id_aux = 29
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 5): #Year: 2023, DOY:249
            id_aux = 11
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour >= 6 and time_text.hour <= 8): #Year: 2023, DOY:249
            id_aux = 10
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour >= 8 and time_text.hour <= 10): #Year: 2023, DOY:249
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute <= 20): #Year: 2023, DOY:249
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute >= 40) or (time_text.hour >= 0 and time_text.hour < 3): #Year: 2023, DOY:249
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 0): #Year: 2023, DOY:249
            id_aux = 16
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 10): #Year: 2023, DOY:249
            id_aux = 15
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 0): #Year: 2023, DOY:249
            id_aux = 20
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 or time_text.hour == 4): #Year: 2023, DOY:249
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 5 and time_text.minute == 30) or (time_text.hour == 0 and time_text.minute == 20) or (time_text.hour == 0 and time_text.minute == 40): #Year: 2023, DOY:248
            id_aux = 38
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6) or (time_text.hour == 7) or (time_text.hour == 12 and time_text.minute == 20) or (time_text.hour == 12 and time_text.minute == 40): #Year: 2023, DOY:248
            id_aux = 37
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 7 and time_text.minute == 50) or (time_text.hour == 13 and time_text.minute == 30): #Year: 2023, DOY:248
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 8 and time_text.minute <= 30) or (time_text.hour == 8 and time_text.minute == 50) or (time_text.hour == 9) or (time_text.hour == 11 and time_text.minute == 50): #Year: 2023, DOY:248
            id_aux = 35
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 11 and time_text.minute == 30): #Year: 2023, DOY:248
            id_aux = 30
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 9 and time_text.minute == 20): #Year: 2023, DOY:248
            id_aux = 32
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour >= 5 and time_text.hour <= 11) or (time_text.hour >= 2 and time_text.hour <= 4): #Year: 2023, DOY:248
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute >= 10) or (time_text.hour >= 0 and time_text.hour < 2): #Year: 2023, DOY:248
            id_aux = 15
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 50) or (time_text.hour == 0 and time_text.minute == 0): #Year: 2023, DOY:248
            id_aux = 21
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 0 and time_text.minute == 20): #Year: 2023, DOY:248
            id_aux = 24
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 1 and time_text.minute == 50): #Year: 2023, DOY:248
            id_aux = 18
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 0): #Year: 2023, DOY:248
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 20): #Year: 2023, DOY:248
            id_aux = 16
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 23): #Year: 2023, DOY:247
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour >= 0 and time_text.hour < 2): #Year: 2023, DOY:247
            id_aux = 22
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute <= 40): #Year: 2023, DOY:247
            id_aux = 16
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 50): #Year: 2023, DOY:247
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 10): #Year: 2023, DOY:247
            id_aux = 14
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 or time_text.hour == 4): #Year: 2023, DOY:247
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour >= 0 and time_text.hour < 6): #Year: 2023, DOY:191
            id_aux = 20
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 1 and time_text.minute == 43): #Year: 2023, DOY:191
            id_aux = 21
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
        ...
        if (time_text.hour == 1 and time_text.minute == 38): #Year: 2023, DOY:191
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute > 20): #Year: 2023, DOY:191
            id_aux = 15
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute > 50): #Year: 2023, DOY:191
            id_aux = 19
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 5) or (time_text.hour == 6 and time_text.minute == 4): #Year: 2023, DOY:175
            id_aux = 31
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6 and time_text.minute == 14) or (time_text.hour == 6 and time_text.minute == 46): #Year: 2023, DOY:175
            id_aux = 33
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour >= 5 and time_text.hour <= 9): #Year: 2023, DOY:175
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 10 and time_text.minute == 9) or (time_text.hour == 10 and time_text.minute == 30) or (time_text.hour == 10 and time_text.minute == 52): #Year: 2023, DOY:175
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 9 and time_text.minute == 58) or (time_text.hour == 12 and time_text.minute == 28): #Year: 2023, DOY:175
            id_aux = 39
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 10 and time_text.minute == 52) or (time_text.hour == 11 and time_text.minute == 13): #Year: 2023, DOY:175
            id_aux = 34
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 11 and time_text.minute == 2): #Year: 2023, DOY:175
            id_aux = 9
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 11 and time_text.minute == 45) or (time_text.hour == 12 and time_text.minute == 6) or (time_text.hour == 12 and time_text.minute == 17): #Year: 2023, DOY:174
            id_aux = 35
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 23 or time_text.hour <= 4): #Year: 2023, DOY:174
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 12 and time_text.minute == 6) or (time_text.hour == 4 and time_text.minute == 28): #Year: 2023, DOY:173
            id_aux = 31
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 12 and time_text.minute == 17) or (time_text.hour == 2 and time_text.minute == 52) or (time_text.hour == 3 and time_text.minute == 56) or (time_text.hour == 4 and time_text.minute == 17): #Year: 2023, DOY:173
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 12 and time_text.minute == 38) or (time_text.hour == 12 and time_text.minute == 49) or (time_text.hour == 13 and time_text.minute == 10): #Year: 2023, DOY:173
            id_aux = 35
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 23 or time_text.hour <= 4): #Year: 2023, DOY:173
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 2) or (time_text.hour == 3 and time_text.minute == 24): #Year: 2023, DOY:173
            id_aux = 39
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            '''
        '''
        if (time_text.hour == 5 and time_text.minute == 32): #Year: 2023, DOY:172
            id_aux = 10
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 5 and time_text.minute == 21): #Year: 2023, DOY:172
            id_aux = 28
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 12 and time_text.minute == 6): #Year: 2023, DOY:172
            id_aux = 28
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 5 and time_text.minute == 0) or (time_text.hour == 6 and time_text.minute == 25): #Year: 2023, DOY:172
            id_aux = 34
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 6): #Year: 2023, DOY:172
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 12 and time_text.minute > 25) or (time_text.hour == 4 and time_text.minute == 6): #Year: 2023, DOY:172
            id_aux = 33
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 23 or time_text.hour <= 4): #Year: 2023, DOY:172
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 30): #Year: 2023, DOY:172
            id_aux = 38
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            '''
        '''
        if (time_text.hour == 11 and time_text.minute == 34) or (time_text.hour == 4 and time_text.minute == 28): #Year: 2023, DOY:171
            id_aux = 34
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 13 and time_text.minute == 21) or (time_text.hour == 2 and time_text.minute == 52): #Year: 2023, DOY:171
            id_aux = 40
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        id_aux = 9 #Year: 2023, DOY:171 #All Hours
        dataOut.DensityFinal[0,:id_aux]=missing
        dataOut.EDensityFinal[0,:id_aux]=missing
        dataOut.ElecTempFinal[0,:id_aux]=missing
        dataOut.EElecTempFinal[0,:id_aux]=missing
        ...
        if (time_text.hour == 23 or time_text.hour <= 4): #Year: 2023, DOY:171
            id_aux = 13
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 0 and time_text.minute == 33): #Year: 2023, DOY:171
            id_aux = 17
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 16 and time_text.minute == 39): #Year: 2023, DOY:170
            id_aux = 48
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour <= 4): #Year: 2023, DOY:170
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23 and time_text.minute > 10): #Year: 2023, DOY:170
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 1 and time_text.minute == 43): #Year: 2023, DOY:170
            id_aux = 14
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 19) or (time_text.hour == 4 and time_text.minute == 12): #Year: 2023, DOY:170
            id_aux = 39
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 3 and time_text.minute == 40): #Year: 2023, DOY:170
            id_aux = 35
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 4 and time_text.minute == 44): #Year: 2023, DOY:170
            id_aux = 32
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        if (time_text.hour == 20 and time_text.minute == 19): #Year: 2022, DOY:243
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 20 and time_text.minute == 29): #Year: 2022, DOY:243
            id_aux = 30
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 20 and time_text.minute == 44): #Year: 2022, DOY:243
            id_aux = 31
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour <= 8): #Year: 2022, DOY:243
            id_aux = 11
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23): #Year: 2022, DOY:243
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 5 and time_text.minute == 21): #Year: 2022, DOY:243
            id_aux = (36,37)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 5 and time_text.minute == 53): #Year: 2022, DOY:243
            id_aux = (37,38)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 6 and time_text.minute == 4): #Year: 2022, DOY:243
            id_aux = (38,39)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 12 and time_text.minute == 6): #Year: 2022, DOY:243
            id_aux = (29,30)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 14 and time_text.minute == 14): #Year: 2022, DOY:243
            id_aux = (35,36)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 2): #Year: 2022, DOY:243
            id_aux = (41,42)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 0 and time_text.minute == 8): #Year: 2022, DOY:243
            id_aux = 33
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 26): #Year: 2022, DOY:243
            id_aux = (12,13,14)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 36): #Year: 2022, DOY:243
            id_aux = (14,15,16)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 6): #Year: 2022, DOY:243
            id_aux = (36,37,38)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 16): #Year: 2022, DOY:243
            id_aux = (34,35)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 38): #Year: 2022, DOY:243
            id_aux = (35,36)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 20): #Year: 2022, DOY:243
            id_aux = (33,34)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 42): #Year: 2022, DOY:243
            id_aux = 34
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 4 and time_text.minute == 35): #Year: 2022, DOY:243
            id_aux = (36,37)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
        ...
        if (time_text.hour == 3 and time_text.minute == 59): #Year: 2022, DOY:244
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour <= 8): #Year: 2022, DOY:244
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 23): #Year: 2022, DOY:244
            id_aux = 12
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 5 and time_text.minute == 42): #Year: 2022, DOY:244
            id_aux = (32,33)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 11 and time_text.minute == 56): #Year: 2022, DOY:244
            id_aux = (39,40)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 12 and time_text.minute == 52): #Year: 2022, DOY:244
            id_aux = (36,37)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 13 and time_text.minute == 3): #Year: 2022, DOY:244
            id_aux = (37,38)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 11): #Year: 2022, DOY:244
            id_aux = (40,41)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 21): #Year: 2022, DOY:244
            id_aux = (12,13,39,40,41)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            dataOut.EElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 23 and time_text.minute == 53): #Year: 2022, DOY:244
            id_aux = (15,16,17,18)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 2 and time_text.minute == 44): #Year: 2022, DOY:244
            id_aux = (40,41,42)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 37): #Year: 2022, DOY:244
            id_aux = (36,37)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 4 and time_text.minute == 9): #Year: 2022, DOY:244
            id_aux = (32,33,34)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 4 and time_text.minute == 20): #Year: 2022, DOY:244
            id_aux = 37
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 4 and time_text.minute == 31): #Year: 2022, DOY:244
            id_aux = 33
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        if (time_text.hour <= 10): #Year: 2022, DOY:245
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 5 and time_text.minute == 10): #Year: 2022, DOY:245
            id_aux = 35
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 5 and time_text.minute == 21): #Year: 2022, DOY:245
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 11 and time_text.minute == 45): #Year: 2022, DOY:245
            id_aux = 7
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            '''
        '''
        if (time_text.hour == 23 and time_text.minute > 30): #Year: 2022, DOY:241
            id_aux = 17
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
        ...
        if (time_text.hour == 13 and time_text.minute == 36): #Year: 2022, DOY:241
            id_aux = 33
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
            ...
            dataOut.PhyFinal[0,id_aux:]=missing
            dataOut.EPhyFinal[0,id_aux:]=missing
        if (time_text.hour == 13 and time_text.minute == 47): #Year: 2022, DOY:241
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        if (time_text.hour == 13 and time_text.minute == 57): #Year: 2022, DOY:241
            id_aux = 36
            dataOut.DensityFinal[0,id_aux:]=missing
            dataOut.EDensityFinal[0,id_aux:]=missing
            dataOut.ElecTempFinal[0,id_aux:]=missing
        ...
        if (time_text.hour == 5 and time_text.minute == 42): #Year: 2022, DOY:242
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 5 and time_text.minute == 53): #Year: 2022, DOY:242
            id_aux = 9
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 6): #Year: 2022, DOY:242
            id_aux = 9
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 6 and time_text.minute == 36): #Year: 2022, DOY:242
            id_aux = (10,36,37)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 7): #Year: 2022, DOY:242
            id_aux = 9
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 13 and time_text.minute == 32): #Year: 2022, DOY:242
            id_aux = (36,37)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 23 or time_text.hour <= 4): #Year: 2022, DOY:242
            id_aux = 15
            dataOut.DensityFinal[0,:id_aux]=missing
            dataOut.EDensityFinal[0,:id_aux]=missing
            dataOut.ElecTempFinal[0,:id_aux]=missing
            ...
            dataOut.PhyFinal[0,:id_aux]=missing
            dataOut.EPhyFinal[0,:id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 13): #Year: 2022, DOY:242
            id_aux = (37,38)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 3 and time_text.minute == 34): #Year: 2022, DOY:242
            id_aux = (35,36)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 4 and time_text.minute == 17): #Year: 2022, DOY:242
            id_aux = (34,35)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 18 and time_text.minute == 30): #Year: 2022, DOY:242
            id_aux = (26,27)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
            ...
            dataOut.PhyFinal[0,id_aux]=missing
            dataOut.EPhyFinal[0,id_aux]=missing
        if (time_text.hour == 14 and time_text.minute == 14): #Year: 2022, DOY:242
            id_aux = (35,36)
            dataOut.DensityFinal[0,id_aux]=missing
            dataOut.EDensityFinal[0,id_aux]=missing
            dataOut.ElecTempFinal[0,id_aux]=missing
