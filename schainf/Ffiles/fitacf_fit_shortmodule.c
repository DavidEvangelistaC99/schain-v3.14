...
f2py_cb_start_clock();
    ...
    if (cb->capi==NULL) {
        capi_longjmp_ok = 0;
        cb->capi = PyObject_GetAttrString(fitacf_fit_short_module,"fcn");
        CFUNCSMESSPY("cb:cb_fcn_in_lmdif__user__routines_capi=",cb->capi);
    }
    if (cb->capi==NULL) {
...
/*decl*/
    ...
    PyArrayObject *capi_ifitp_as_array = NULL;
...
/*frompyobj*/
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.fit: failed to create array from the 2nd argument `taup`";
    capi_taup_as_array = ndarray_from_pyobj(  NPY_FLOAT,1,taup_Dims,taup_Rank,  capi_taup_intent,taup_capi,capi_errmess);
    if (capi_taup_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = fitacf_fit_short_error;
            PyErr_SetString(capi_err, capi_errmess);
        }
    } else {
        taup = (float *)(PyArray_DATA(capi_taup_as_array));

    /* Processing variable paramp */
    paramp_Dims[0]=10;
    capi_paramp_intent |= F2PY_INTENT_IN|F2PY_INTENT_OUT;
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.fit: failed to create array from the 7th argument `paramp`";
    capi_paramp_as_array = ndarray_from_pyobj(  NPY_FLOAT,1,paramp_Dims,paramp_Rank,  capi_paramp_intent,paramp_capi,capi_errmess);
    if (capi_paramp_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = fitacf_fit_short_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        paramp = (float *)(PyArray_DATA(capi_paramp_as_array));

    /* Processing variable ebp */
    ebp_Dims[0]=10;
    capi_ebp_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.fit: failed to create array from the hidden `ebp`";
    capi_ebp_as_array = ndarray_from_pyobj(  NPY_FLOAT,1,ebp_Dims,ebp_Rank,  capi_ebp_intent,Py_None,capi_errmess);
    if (capi_ebp_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = fitacf_fit_short_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        ebp = (float *)(PyArray_DATA(capi_ebp_as_array));
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.fit: failed to create array from the 13rd argument `ifitp`";
    capi_ifitp_as_array = ndarray_from_pyobj(  NPY_INT,1,ifitp_Dims,ifitp_Rank,  capi_ifitp_intent,ifitp_capi,capi_errmess);
    if (capi_ifitp_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = fitacf_fit_short_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        ifitp = (int *)(PyArray_DATA(capi_ifitp_as_array));
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.fit: failed to create array from the 3rd argument `rhop`";
    capi_rhop_as_array = ndarray_from_pyobj(  NPY_FLOAT,1,rhop_Dims,rhop_Rank,  capi_rhop_intent,rhop_capi,capi_errmess);
    if (capi_rhop_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = fitacf_fit_short_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        rhop = (float *)(PyArray_DATA(capi_rhop_as_array));

    /* Processing variable covar */
    covar_Dims[0]=nl,covar_Dims[1]=nl;
    capi_covar_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.fit: failed to create array from the 4th argument `covar`";
    capi_covar_as_array = ndarray_from_pyobj(  NPY_FLOAT,1,covar_Dims,covar_Rank,  capi_covar_intent,covar_capi,capi_errmess);
    if (capi_covar_as_array == NULL) {
        ...
        covar = (float *)(PyArray_DATA(capi_covar_as_array));

    /* Processing variable cinv */
    cinv_Dims[0]=nl,cinv_Dims[1]=nl;
    capi_cinv_intent |= F2PY_INTENT_IN|F2PY_INTENT_OUT;
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.fit: failed to create array from the 5th argument `cinv`";
    capi_cinv_as_array = ndarray_from_pyobj(  NPY_FLOAT,1,cinv_Dims,cinv_Rank,  capi_cinv_intent,cinv_capi,capi_errmess);
    if (capi_cinv_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = fitacf_fit_short_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        cinv = (float *)(PyArray_DATA(capi_cinv_as_array));

    /* Processing variable sigma2p */
    sigma2p_Dims[0]=nl;
    capi_sigma2p_intent |= F2PY_INTENT_IN|F2PY_INTENT_OUT;
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.fit: failed to create array from the 6th argument `sigma2p`";
    capi_sigma2p_as_array = ndarray_from_pyobj(  NPY_FLOAT,1,sigma2p_Dims,sigma2p_Rank,  capi_sigma2p_intent,sigma2p_capi,capi_errmess);
    if (capi_sigma2p_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = fitacf_fit_short_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        sigma2p = (float *)(PyArray_DATA(capi_sigma2p_as_array));
...
/*end of pyobjfrom*/
        ...
        capi_buildvalue = Py_BuildValue("NNNNi",capi_cinv_as_array,capi_sigma2p_as_array,capi_paramp_as_array,capi_ebp_as_array,ist);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    }  /* if (capi_sigma2p_as_array == NULL) ... else of sigma2p */
    /* End of cleaning variable sigma2p */
    }  /* if (capi_cinv_as_array == NULL) ... else of cinv */
    ...
    if((PyObject *)capi_rhop_as_array!=rhop_capi) {
        Py_XDECREF(capi_rhop_as_array); }
    }  /* if (capi_rhop_as_array == NULL) ... else of rhop */
    ...
    if((PyObject *)capi_ifitp_as_array!=ifitp_capi) {
        Py_XDECREF(capi_ifitp_as_array); }
    }  /* if (capi_ifitp_as_array == NULL) ... else of ifitp */
    ...
    }  /* if (capi_ebp_as_array == NULL) ... else of ebp */
    /* End of cleaning variable ebp */
    }  /* if (capi_paramp_as_array == NULL) ... else of paramp */
    /* End of cleaning variable paramp */
    if((PyObject *)capi_taup_as_array!=taup_capi) {
        Py_XDECREF(capi_taup_as_array); }
    }  /* if (capi_taup_as_array == NULL) ... else of taup */
...
f2py_start_clock();
    ...
    if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
        ...
        capi_kwlist,&fcn_cb.capi,&x_capi,&fvec_capi,&tol_capi,&info_capi,&iwa_capi,&wa_capi,&m_capi,&n_capi,&lwa_capi,&PyTuple_Type,&fcn_xa_capi))
        return NULL;
/*frompyobj*/
...
if(F2PyCapsule_Check(fcn_cb.capi)) {
  ...
  fcn_cptr = cb_fcn_in_lmdif__user__routines;
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif1: failed to create array from the 2nd argument `x`";
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif1: failed to create array from the 3rd argument `fvec`";
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif1: failed to create array from the 7th argument `wa`";
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif1: failed to create array from the 6th argument `iwa`";
...
if(F2PyCapsule_Check(fcn_cb.capi)) {
  ...
  fcn_cptr = cb_fcn_in_lmdif__user__routines;
    ...
    ;
    capi_x_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif: failed to create array from the 2nd argument `x`";
    capi_x_as_array = ndarray_from_pyobj(  NPY_FLOAT,1,x_Dims,x_Rank,  capi_x_intent,x_capi,capi_errmess);
    if (capi_x_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_fvec_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif: failed to create array from the 3rd argument `fvec`";
    capi_fvec_as_array = ndarray_from_pyobj(  NPY_FLOAT,1,fvec_Dims,fvec_Rank,  capi_fvec_intent,fvec_capi,capi_errmess);
    if (capi_fvec_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif: failed to create array from the 9th argument `diag`";
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif: failed to create array from the 15th argument `fjac`";
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif: failed to create array from the 16th argument `ipvt`";
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif: failed to create array from the 17th argument `qtf`";
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif: failed to create array from the 18th argument `wa1`";
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif: failed to create array from the 19th argument `wa2`";
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif: failed to create array from the 20th argument `wa3`";
    ...
    const char * capi_errmess = "fitacf_fit_short.fitacf_fit_short.lmdif: failed to create array from the 21st argument `wa4`";
...
static FortranDataDef f2py_routine_defs[] = {
    {"fit",-1,{{-1}},0,0,(char *)  F_FUNC(fit,FIT),  (f2py_init_func)f2py_rout_fitacf_fit_short_fit,doc_f2py_rout_fitacf_fit_short_fit},
    {"spect1",-1,{{-1}},0,0,(char *)  F_WRAPPEDFUNC(spect1,SPECT1),  (f2py_init_func)f2py_rout_fitacf_fit_short_spect1,doc_f2py_rout_fitacf_fit_short_spect1},
    {"gaussq",-1,{{-1}},0,0,(char *)  F_FUNC(gaussq,GAUSSQ),  (f2py_init_func)f2py_rout_fitacf_fit_short_gaussq,doc_f2py_rout_fitacf_fit_short_gaussq},
    {"lmdif1",-1,{{-1}},0,0,(char *)  F_FUNC(lmdif1,LMDIF1),  (f2py_init_func)f2py_rout_fitacf_fit_short_lmdif1,doc_f2py_rout_fitacf_fit_short_lmdif1},
    {"lmdif",-1,{{-1}},0,0,(char *)  F_FUNC(lmdif,LMDIF),  (f2py_init_func)f2py_rout_fitacf_fit_short_lmdif,doc_f2py_rout_fitacf_fit_short_lmdif},
    {"spmpar",-1,{{-1}},0,0,(char *)  F_WRAPPEDFUNC(spmpar,SPMPAR),  (f2py_init_func)f2py_rout_fitacf_fit_short_spmpar,doc_f2py_rout_fitacf_fit_short_spmpar},
...
PyMODINIT_FUNC PyInit_fitacf_fit_short(void) {
    ...
    s = PyUnicode_FromString(
        "This module 'fitacf_fit_short' is auto-generated with f2py (version:2.0.2).\nFunctions:\n"
