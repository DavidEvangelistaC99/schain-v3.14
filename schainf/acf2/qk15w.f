...
c        write(*,*) " FVAL1 ", F(ABSC1), W(ABSC1,P1,P2,P3,P4,KP), ABSC1
        FVAL2 = F(ABSC2)*W(ABSC2,P1,P2,P3,P4,KP)
        
c        write(*,*) " FVAL2 ", F(ABSC2), W(ABSC2,P1,P2,P3,P4,KP), ABSC2
        FV1(JTW) = FVAL1
        FV2(JTW) = FVAL2
        FSUM = FVAL1+FVAL2
        RESG = RESG+WG(J)*FSUM
        RESK = RESK+WGK(JTW)*FSUM
        write(*,*) " FSUM 1, WGGK ", FSUM, WGK(JTW)
   ...
   20 CONTINUE
      write(*,*) " Before ", RESULT, RESK,HLGTH
      RESULT = RESK*HLGTH
      write(*,*) " After ", RESULT
