...
#opObj11.addParameter(name='wintitle', value='RTIPlot NEW', format='str')
#opObj11.addParameter(name='zmin', value=dBmin)
#opObj11.addParameter(name='zmax', value=dBmax)
#opObj11.addParameter(name='ymin', value=ymin, format='int')
#opObj11.addParameter(name='ymax', value=ymax, format='int')
#opObj11.addParameter(name='xmin', value=14, format='int')
...
#opObj11 = procUnitConfObjSousySpectra.addOperation(name='SpectraHeisPlot', optype='external')
#opObj11.addParameter(name='id', value='1', format='int')
#opObj11.addParameter(name='wintitle', value='Spectra NEW', format='str')
# opObj11.addParameter(name='zmin', value=dBmin)
# opObj11.addParameter(name='zmax', value=dBmax)
...
opObj12 = procUnitConfObjSousySpectra.addOperation(name='SpectraCutPlot', optype='external')
...
opObj12.addParameter(name='save', value=figpath, format='str')
